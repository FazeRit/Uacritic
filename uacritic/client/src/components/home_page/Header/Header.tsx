...
const Header = () => {
    ...
    return <div>
        <div className="mx-[5.2vw]">
            <div className="flex flex-row justify-between">
                <div className="flex flex-row ">
                    <div className="mt-2">{/*my-[0.2vw]*/}
                        <Image className="my-[0.2vw]" alt={'Logo of UaCritic'} src={mainLogo}/>
                    </div>
                ...
                <div
                    ...
                    {/*TODO: make links*/}
                    <Link href="/signup"
                          className="mx-5 roboto-regular transition duration-300 hover:text-blue-900">Зареєструватися</Link>
                    <Link href="/signin"
                          className="mx-5 roboto-regular transition duration-300 hover:text-blue-900">Авторизуватися</Link>
                    <div>
        ...
        <div hidden={!showMenu} className={`bg-gray-200 w-[100vw] pb-[2vw] lg:hidden`}>
            <NavbarGamburger/>
        </div>
        <NavBar/>
    </div>
