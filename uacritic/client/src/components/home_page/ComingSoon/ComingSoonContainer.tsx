...
const ComingSoonContainer = <T,>({
    ...
    if (error) {
        return <div className="text-center py-4 text-red-500">Помилка завантаження даних</div>;
    }
        ...
        <div className="border-t-lineMain border-t-[3px] md:border-l-[3px] md:border-r-[3px] border-l-lineMain border-r-lineMain mt-[4vw]">
            <div className="flex flex-col">
                <div className="flex flex-row mt-[0.5vw] sm:p-[2vw] w-full">
                    {reverse ? (
                        <>
                            <div className="sm:mr-[2vw] lg:ml-[2vw] md:mt-[1vw] lg:mt-[3vw] sm:w-[40vw] md:w-[80vw] lg:w-[50vw]">
                                <ComingSoonText
                                    title={title}
                            ...
                            <div className="flex flex-col">
                                <p className="md:text-[2.5vw] lg:text-[2vw] sm:ml-[23.4vw] lg:ml-[16vw] md:ml-[5.3vw] roboto-bold text-primaryText">
                                    Coming soon
                                </p>
                                <img className="sm:w-[40vw] sm:h-[40vw] md:w-[30vw] ml-auto md:h-[30vw] mt-[1vw] rounded-3xl"
                                     src={imageUrl}
                                     alt={title}
                                />
                            </div>
                        ...
                        <>
                            ...
                            <div className="sm:ml-[4vw] md:ml-[2vw] lg:mr-[2vw] md:mt-[1vw] lg:mt-[3vw] sm:w-[30vw] md:w-[80vw] lg:w-[50vw]">
                                <ComingSoonText
                                    title={title}
                                    description={description}
                                />
            ...
            <div>
                {reverse ? (
                    <div>
                        <svg className="sm:w-full w-full h-auto" viewBox="0 0 1214 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <svg className="sm:w-full w-full h-auto" viewBox="0 0 1214 16.1" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line y1="-0.5" x2="1216" y2="-0.5" transform="matrix(0.999999 -0.00164948 0.00165084 0.999999 0 16)" stroke="#646363" />
