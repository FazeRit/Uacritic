...
const Card: FC<{ item: any, category: string }> = ({ item, category }) => {
    return (
        <div className="flex flex-col sm:w-[40vw] lg:w-[16vw] md:w-[20vw] bg-primaryText text-white md:h-[23vw] lg:h-[18vw] sm:min-h-[14rem] rounded-2xl transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="flex flex-row mx-[1vw] lg:mt-[0.5vw] md:mt-[0.8vw] sm:mt-[1vw] min-h-[1.5vw]">
                ...
                <p className="lg:ml-[1vw] sm:ml-[2vw] md:ml-[0.5vw] sm:h-[4vw] md:w-[3vw] lg:w-[2vw] md:h-[3vw]">
                    <svg className="cursor-pointer sm:w-[5vw] sm:h-[5vw] md:w-[3vw] lg:h-[1.5vw] lg:mt-[0.2vw] lg:w-[2vw] md:h-[3vw]" width="2vw" height="2vw" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">
