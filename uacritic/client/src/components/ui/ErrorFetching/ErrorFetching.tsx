const ErrorFetching = () => {
    return (
        <div className="flex justify-center items-center w-screen bg-bgMain h-screen">
            <div className="flex flex-col items-center bg-red-100 border border-red-500 p-4 rounded-lg shadow-md">
                <svg className="w-12 h-12 text-red-500 mb-4" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <p className="text-red-500 font-semibold text-lg">Помилка завантаження даних</p>
            </div>
        </div>
    );
};
