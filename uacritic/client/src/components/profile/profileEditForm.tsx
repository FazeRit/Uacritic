        ...
        <section className="flex flex-col items-center roboto-medium sm:w-full md:w-[64vw] lg:w-[84vw]">
            ...
            >
                <label htmlFor="newUserName"
                       className="mt-[0.6vw] sm:mt-[4vw] md:mt-[2vw] lg:mt-[0.6vw]">Nickname</label>
                <input type="text" id="newUserName"
                       className="px-[1vw] sm:h-[8vw] md:h-[6vw] lg:h-[3vw] text-[#CACED8] lg:text-lg rounded-md sm:mt-[2vw] md:mt-[1.2vw] lg:mt-[1vw]"/>

                <label htmlFor="newEmail" className="mt-[0.6vw] sm:mt-[4vw] md:mt-[2vw] lg:mt-[0.6vw]">Email</label>
                <input type="email" id="newEmail"
                       className="px-[1vw] sm:h-[8vw] md:h-[6vw] lg:h-[3vw] text-[#CACED8] lg:text-lg rounded-md sm:mt-[2vw] md:mt-[1.2vw] lg:mt-[1vw]"/>

                <label htmlFor="newDate" className="mt-[0.6vw] sm:mt-[4vw] md:mt-[2vw] lg:mt-[0.6vw]">Date of
                    birth</label>
                <input type="date" id="newDate"
                       className="px-[1vw] sm:h-[8vw] md:h-[6vw] lg:h-[3vw] text-[#CACED8] lg:text-lg lg:text-[0.8vw] rounded-md sm:mt-[2vw] md:mt-[1.2vw] lg:mt-[1vw]"/>
