const AuthRequireError = () => {
    return (
        <div className="sm:w-full sm:mt-8 lg:mt-0 lg:w-[480px] p-4 bg-white rounded-lg shadow-lg">
            <div className="flex flex-col items-center bg-red-100 border border-red-500 p-4 rounded-lg shadow-md">
                ...
                <p className="text-red-500 font-semibold text-lg">You must be logged in to access this content</p>
            </div>
        </div>
    );
};

export default AuthRequireError;