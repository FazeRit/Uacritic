...
interface AuthConfirmPasswordInputProps {
    value: string;
...
const AuthConfirmPasswordInput: FC<AuthConfirmPasswordInputProps> = ({value, onChange, error, disabled}) => {
    return (
        <div className="relative sm:mt-8">
            ...
            {error && <p className="text-red-500 text-sm absolute bottom-[-1.5rem] left-0 w-full">{error}</p>}
        </div>
    );
};
