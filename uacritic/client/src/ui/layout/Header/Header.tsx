                    ...
                    <div className="lg:flex items-center space-x-5 sm:hidden mt-5">
                        {loggedIn ? (
                            <>
                                ...
                                <Link href="/profile"
                                      className="transition duration-300 hover:text-blue-900">Profile</Link>
                            </>
                        ) : (
                            <>
                                <Link href="/signup" className="transition duration-300 hover:text-blue-900">Sign
                                    up</Link>
                                <Link href="/signin" className="transition duration-300 hover:text-blue-900">Sign
                                    in</Link>
                            </>
                        )}
                    </div>
