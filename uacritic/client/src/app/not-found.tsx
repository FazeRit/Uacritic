    ...
    return (
        <div className="lg:mt-[5vw] md:mt-[10vw] md:mx-[20vw] lg:mx-[30vw] md:w-[60vw] lg:w-[40vw] sm:mt-[10vw] sm:mx-[10vw] sm:w-[80vw]">
            <div className="flex flex-row lg:h-[10vw] md:h-[20vw] sm:h-[30vw]">
                <Image src={notFoundHedgehog} alt='cute hedgehog' className="lg:w-[20vw] md:w-[30vw] md:h-[20vw] lg:h-[10vw] sm:w-[40vw] sm:h-[30vw]" width={200} height={200}></Image>
            ...
            <div className="lg:h-[15vw] md:h-[20vw] sm:h-[40vw] flex flex-col">
                ...
                <p className="lg:h-[6vw] sm:h-[10vw] mx-auto text-primaryText text-center">Упс... такого ресурсу не існує, можливо, Ви бажаєте перейти на головну сторінку</p>
                <Link
